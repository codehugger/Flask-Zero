...
from .extensions import assets, login_manager
...
def configure_template_filters(app):
    "Configure filters and tags for jinja2"
    pass
...
def configure_views(app):
    ...
    def signin():
        ...
        if form.validate_on_submit():
            ...
            if user is not None and authenticated == True:
                login_user(user)
            ...
            flash("Unable to sign you in.", "error")
